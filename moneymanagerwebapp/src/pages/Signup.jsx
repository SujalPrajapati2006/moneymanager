...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-slate-50">
            <Header />
            <div className="flex-grow w-full relative flex items-center justify-center py-8 px-4 sm:px-6 overflow-y-auto">
                {/* Background image with blur*/}
                <img src={assets.login_bg} alt="Background" className="absolute inset-0 w-full h-full object-cover filter blur-sm" />

                <div className="relative z-10 w-full max-w-lg">
                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 sm:p-8 max-h-[88vh] overflow-y-auto border border-gray-100">
                        <h3 className="text-xl sm:text-2xl font-semibold text-black text-center mb-1">
                            Create An Account
                        </h3>
